...
<body>
  <div class="ui inverted segment">
        <div class="ui inverted secondary pointing menu">
            <a class="item" href="{{ url('index1') }}">Introduction</a>
            ...
            <a class="item" href="{{ url('index3') }}">Single page
                application</a>
            <a class="active item" href="{{ url('index4') }}">Create custom
                bindings</a>
    ...
    <div class="ui two column stackable left aligned grid">
        <div class="left aligned row">
            <div class="column">
                    ...
                    <div id="carouselExampleControls" data-bs-touch="false" class="carousel slide" data-bs-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                {!! $module[15]->description !!}
                            </div>
                            <div class="carousel-item">
                                {!! $module[16]->description !!}
                            </div>
                            <div class="carousel-item">
                                {!! $module[17]->description !!}
                            </div>
                            <div class="carousel-item">
                ...
                <div class="ui segment" style="height: 350px; width: 100%; overflow-y: auto;">
