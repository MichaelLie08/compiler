...
<head>
    ...
    <title>Candidate Details :: Finate - Job Portal Website Template Using Bootstrap 5</title>
            ...
            <div class="team-details-item">
              ...
              <div class="candidate-details-wrap">
                ...
                <div class="candidate-details-content">
                  ...
                  <div class="content-item">
                    <h4 class="title">Diploma In Fine Arts <span>//</span> <span>2020 - 2021</span></h4>
                    <h5 class="sub-title">Franklin and Marshall College</h5>
                    <p class="desc">It is a long established fact that a reader will be distracted the readable content of a page when looking atits layout the point of using is that has moreo less normal a distribution letters content publishing packages web page editors.</p>
                  </div>
                </div>
              ...
              <div class="candidate-details-wrap">
                ...
                <div class="candidate-details-content">
                  ...
                  <div class="content-item">
                    <h4 class="title">Uuser Interface Designer <span>//</span> <span>2017 - 2020</span></h4>
                    <h5 class="sub-title">Lambent Illumination Ltd.</h5>
                    <p class="desc">It is a long established fact that a reader will be distracted the readable content of a page when looking atits layout the point of using is that has moreo less normal a distribution letters content publishing packages web page editors.</p>
                  </div>
                  <div class="content-item">
                    <h4 class="title">Senior UI Designer <span>//</span> <span>2020 - Present</span></h4>
