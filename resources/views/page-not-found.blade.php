...
<head>
    ...
    <title>Page Not Found :: Finate - Job Portal Website Template Using Bootstrap 5</title>
          ...
          <div class="col-lg-8">
            <div class="page-not-found-wrap">
              ...
              <div class="page-not-found-content">
                ...
                <a class="btn-theme" href="index.html"><i class="icofont-long-arrow-left"></i> Back to home</a>
              </div>
            </div>
          </div>
        </div>
