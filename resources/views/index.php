...
<head>
	...
	<title>Magangku - Job Portal Website Template Using Bootstrap 5</title>
							...
							<div class="header-align-center">
								<div class="header-navigation-area position-relative">
									<ul class="main-menu nav">
										...
										<li><a href="job.html"><span>Find Apprenticeship</span></a></li>
			...
			<section class="home-slider-area">
										...
										<div class="col-12 col-lg-8">
											<div class="slider-content">
												<h2 class="title"><span class="counter"
														data-counterup-delay="80">2,568</span> apprenticeship available <br>You can
													choose your dream apprenticeship</h2>
												<p class="desc">Find great apprenticeship for build your bright career. Have many
												apprenticeship in this plactform.</p>
											</div>
										</div>
										<div class="col-12">
															...
															<div class="col-lg-auto col-sm-6 col-12 flex-grow-1">
																<div class="form-group">
																	<input type="text" class="form-control"
																		placeholder="apprenticeship title or keywords">
																</div>
															</div>
															<div class="col-lg-auto col-sm-6 col-12 flex-grow-1">
																<div class="form-group">
				...
				<div class="home-slider-shape">
					<img class="shape1" data-aos="fade-down" data-aos-duration="1500"
						src="assets/img/slider/vector1.png" width="270" height="234" alt="Image-HasTech">
					<img class="shape2" data-aos="fade-left" data-aos-duration="2000"
						src="assets/img/slider/vector2.png" width="201" height="346" alt="Image-HasTech">
					<img class="shape3" data-aos="fade-right" data-aos-duration="2000"
						src="assets/img/slider/vector3.png" width="276" height="432" alt="Image-HasTech">
					<img class="shape4" data-aos="flip-left" data-aos-duration="1500"
						src="assets/img/slider/vector4.png" width="127" height="121" alt="Image-HasTech">
				</div>
			</section>
					...
					<div class="row">
						<div class="col-12">
							<div class="section-title text-center">
								<h3 class="title">Apprenticeship Category</h3>
								<div class="desc">
					...
					<div class="row row-gutter-20">
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Accounting/Finance
											<span>(305)</span></a></h3>
								</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Production/Operation
											<span>(95)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Education/Training
											<span>(212)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Design/Creative <span>(93)</span></a>
									</h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Health & Fitness <span>(4)</span></a>
									</h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Research/Consultancy
											<span>(34)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Engineer/Architects
											<span>(376)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Telecommunication
											<span>(450)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Data Entry/Operator
											<span>(25)</span></a></h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="job-category-item">
								<div class="content">
									<h3 class="title"><a href="job-details.html">Marketing/Sales <span>(666)</span></a>
									</h3>
								</div>
								<a class="overlay-link" href="job-details.html"></a>
							</div>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/1.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Darkento Ltd.</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
									<h3 class="title">Front-end Developer</h3>
									<h5 class="work-type">Online</h5>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/2.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Inspire Fitness Co.</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
									<h3 class="title">Senior UI Designer</h3>
									<h5 class="work-type" data-text-color="#ff7e00">Onsite</h5>
									<p class="desc">CSS3, HTML5, Javascript, Bootstrap, Jquery</p>
								</div>
								<div class="recent-job-info">
									<a class="btn-theme btn-sm" href="job-details.html">Apply Now</a>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/3.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Cogent Data</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/4.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Obelus Concepts</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
									<h3 class="title">UX Researcher</h3>
									<h5 class="work-type" data-text-color="#ff7e00">Onsite</h5>
									<p class="desc">CSS3, HTML5, Javascript, Bootstrap, Jquery</p>
								</div>
								<div class="recent-job-info">
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/5.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Sanguine Skincare</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
									<h3 class="title">Android App Developer</h3>
									<h5 class="work-type" data-text-color="#ff7e00">Onsite</h5>
									<p class="desc">CSS3, HTML5, Javascript, Bootstrap, Jquery</p>
								</div>
								<div class="recent-job-info">
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/6.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Flux Water Gear</h4>
										<p class="address">New York, USA</p>
									</div>
								</div>
								<div class="main-content">
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/8.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Inspire Fitness Co.</h4>
										<p class="address">New York, USA</p>
						...
						<div class="col-md-6 col-lg-4">
							...
							<div class="recent-job-item">
								<div class="company-info">
									<div class="logo">
										<img src="assets/img/companies/9.jpg" width="75" height="75" alt="Image-HasTech">
									</div>
									<div class="content">
										<h4 class="name">Cogent Data</h4>
										<p class="address">New York, USA</p>
							...
							<div class="working-process-content-wrap">
								...
								<div class="working-col">
									...
									<div class="working-process-item">
										...
										<div class="content">
											<h4 class="title">Find Your Apprenticeship</h4>
											<p class="desc">It is long established fact reader distracted readable
												content</p>
										</div>
										<div class="shape-arrow-icon">
							...
							<div class="divider-content text-center">
								...
								<div class="divider-btn-group">
									...
									<a class="btn-divider btn-divider-app-store" data-aos="fade-down"
										...
										<img src="assets/img/photos/mac-os.png" width="201" height="63" class="icon"
											alt="Image-HasTech">
									</a>
								</div>
							</div>
											...
											<div class="testi-inner-content">
												<div class="testi-author">
													<div class="testi-thumb">
														<img src="assets/img/testimonial/1.jpg" width="75" height="75"
															alt="Image-HasTech">
													</div>
													<div class="testi-info">
														<h4 class="name">Roselia Hamets</h4>
														<span class="designation">Apprentice</span>
													</div>
												</div>
												<div class="testi-content">
													<p class="desc">It is a long established fact that reader will
														...
														using that has more-or-less normal distribution of letters
											...
											<div class="testi-inner-content">
												<div class="testi-author">
													...
													<div class="testi-info">
														...
														<span class="designation">University</span>
													</div>
												</div>
												<div class="testi-content">
													<p class="desc">It is a long established fact that reader will
									...
									<div class="swiper-slide">
										...
										<div class="testimonial-item">
											<div class="testi-inner-content">
												<div class="testi-author">
													<div class="testi-thumb">
														<img src="assets/img/testimonial/4.jpg" width="75" height="75"
															alt="Image-HasTech">
													</div>
													<div class="testi-info">
									...
									<div class="swiper-slide">
										...
										<div class="testimonial-item">
											<div class="testi-inner-content">
												<div class="testi-author">
													<div class="testi-thumb">
														<img src="assets/img/testimonial/5.jpg" width="75" height="75"
															alt="Image-HasTech">
													</div>
													<div class="testi-info">
				...
				<div class="container">
					...
					<div class="row align-items-center post-home-style row-gutter-40">
						<div class="col-md-6 col-lg-4" data-aos="fade-right">
							...
							<div class="post-item">
								<div class="thumb">
									<a href="blog-details.html"><img src="assets/img/blog/1.jpg" alt="Image" width="370"
											height="270"></a>
								</div>
								<div class="content">
									<div class="author">By <a href="blog.html">Walter Houston</a></div>
									<h4 class="title"><a href="blog-details.html">It long established fact that reader
						...
						<div class="col-md-6 col-lg-4" data-aos="fade-left">
							...
							<div class="post-item">
								<div class="thumb mb--0">
									<a href="blog-details.html"><img src="assets/img/blog/h1.jpg" alt="Image"
						...
						<div class="col-lg-4" data-aos="fade-left">
							<div class="post-home-list-style">
								...
								<div class="post-item">
									<div class="content">
										<div class="author">By <a href="blog.html">Walter Houston</a></div>
										<h4 class="title"><a href="blog-details.html">With WooLentor's drag-and drop
					...
					<div class="row">
						<div class="col-12">
							<div class="footer-bottom-content">
								<p class="copyright">© 2021 Magangku.</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="offcanvas-body">
				...
				<div class="mobile-menu-items">
					<ul class="nav-menu">
						...
						<li><a href="#">Find Apprenticeship</a>
							<ul class="sub-menu">
								<li><a href="job.html">Apprenticeship</a></li>
								<li><a href="job-details.html">Apprenticeship Details</a></li>
							</ul>
						</li>
						<li><a href="#">Blog</a>
							<ul class="sub-menu">
