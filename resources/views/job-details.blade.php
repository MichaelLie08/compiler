    ...
    <main class="main-content">
      ...
      <section class="job-details-area">
        <div class="container">
          ...
          <h4 class="row d-flex justify-content-left">
          ...
          <div class="row ">
              ...
              <div class="recent-job-item">
                <div class="company-info">
                  <div class="packages-info">
                    <h4 class="packagesA">Package A</h4>
                  </div>
                </div>
                <div class="main-content">
                  <h3 class="title">IDR 2.500.000</h3>
                  <h5 class="work-type">With Mentor</h5>
                  <p class="desc">Keterangan</p>
                </div>
                <div class="recent-job-info">
                  <a class="btn-theme btn-sm" href="job-details.html">Take Package</a>
                </div>
              </div>
              <!--== End Recent Job Item ==-->
            </div>
            <div class="col-4">
              <div class="recent-job-item">
                <div class="company-info">
                  <div class="packages-info">
                    <h4 class="packagesA">Package B</h4>
                  </div>
                </div>
                <div class="main-content">
                  <h3 class="title">IDR 1.500.000</h3>
                  <h5 class="work-type">Without Mentor</h5>
                  <p class="desc">Keterangan</p>
                </div>
                <div class="recent-job-info">
                  <a class="btn-theme btn-sm" href="job-details.html">Take Package</a>
            ...
            <div class="col-4">
              <div class="recent-job-item">
                <div class="company-info">
                  <div class="packages-info">
                    <h4 class="packagesA">Package C</h4>
                  </div>
                </div>
                <div class="main-content">
                  <h3 class="title">IDR 3.500.000</h3>
                  <h5 class="work-type">With Insentive Mentor</h5>
                  <p class="desc">Keterangan</p>
                </div>
                <div class="recent-job-info">
                  <a class="btn-theme btn-sm" href="job-details.html">Take Package</a>
            ...
            <div class="col-lg-7 col-xl-8">
              <div class="job-details-item">
                <div class="content">
                  ...
                  <p class="desc">It is a long established fact that a reader will be distracted the readable content of
                    page when looking atits layout. The point of using is that has more-or-less normal a distribution of
                    letters, as opposed to usin content publishing packages web page editors. It is a long established
                    fact that a reader will be distracts by the readable content of a page when looking at its layout.
                    The point of using Lorem Ipsum is that has look like readable publishing packages and web page
                    editors.</p>
                  <p class="desc">It is a long established fact that a reader will be distracted the readable content of
                    a page when looking atits layout. The point of using is that has more-or-less normal a distribution
                    of letters, as opposed to usin content publishing packages web page editors.</p>
                </div>
                <div class="content">
                  <h4 class="title">Responsibilities</h4>
                  <ul class="job-details-list">
                    <li><i class="icofont-check"></i> Developing custom themes (WordPress.org & ThemeForest Standards)
                    </li>
                ...
                <div class="content">
                  ...
                  <ul class="job-details-list">
                    <li><i class="icofont-check"></i> Having approved theme/s on ThemeForest will be given high
                      preference.</li>
                    <li><i class="icofont-check"></i> Strong knowledge of WordPress Theme Standards</li>
                    <li><i class="icofont-check"></i> Ability to convert HTML templates into fully functional WordPress
                      themes.</li>
                    <li><i class="icofont-check"></i> Good knowledge in O OP PHP and front-end stuffs like HTML, CSS,
                      JS, jQuery, etc.</li>
                    <li><i class="icofont-check"></i> Moderate knowledge in WordPress Core APIs like options, metadata,
                      REST, hooks, settings, etc.</li>
                    <li><i class="icofont-check"></i> Ability to debug and fix bugs arising from other developer’s code.
                    </li>
                ...
                <div class="content">
                  ...
                  <p class="desc">It doesn’t matter where you went to college or what your CGPA was as long as you are
                    smart, passionate, ready to work hard, and have fun.</p>
                </div>
                <div class="content">
                ...
                <div class="content">
                  ...
                  <p class="desc">Finate is committed to creating the happiest company working for and is proud to
                    provide equal opportunity to all. All the qualified applicants will receive consideration for
                    employment without regard to race, color, ancestry, religion, sex, sexual orientation, age,
                    citizenship, marital status, disability, gender identity, or any other basis protected by federal,
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="dotted">:</td>
                          <td data-text-color="#03a84e">Onsite</td>
                        </tr>
                        <tr>
          ...
          <div class="row">
            <div class="col-12">
              <div class="footer-bottom-content">
                <p class="copyright">© 2021 Finate. Made with <i class="icofont-heart"></i> by <a target="_blank"
